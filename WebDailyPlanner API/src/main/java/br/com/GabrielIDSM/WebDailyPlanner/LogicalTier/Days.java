...
public abstract class Days {
    ...
    public static List<GenericResponseModel> convertIntoGenericResponseModel (List<GenericModel> genericList){
        List<GenericResponseModel> response = new ArrayList<>();
        return response;
    }
    
    public static List<BirthdayResponseModel> convertIntoBirthdayResponseModel (List<BirthdayModel> genericList){
